    ...
    <section id="conteudo" className="py-20 px-4 bg-primary">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-blond mb-8 text-secondary">Nossos E-books</h3>
            <div className="grid gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-blond mb-2 text-foreground">Guia de Direitos do Consumidor</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-blond mb-2 text-foreground">Manual de Direito Imobiliário</h4>
          ...
          <div className="bg-primary border border-secondary/20 p-8 rounded-lg">
            <h3 className="text-2xl font-blond mb-6 text-secondary">Plano de Assinatura</h3>
            ...
            <button className="w-full bg-secondary text-primary py-3 rounded-lg font-blond hover:bg-opacity-90 transition">
              Disponível em breve.
            </button>
          </div>
        </div>
