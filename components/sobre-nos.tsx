      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-2xl font-blond mb-2 text-secondary">Dr. Victor Bignardi</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-2xl font-blond mb-2 text-secondary">Dr. Eduardo Bignardi</h3>
            <p className="text-lg text-foreground">
        ...
        <div className="mt-20 text-center max-w-3xl mx-auto">
          <h3 className="text-2xl font-blond mb-6 text-secondary">Nossa Filosofia</h3>
